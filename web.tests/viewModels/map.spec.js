    ...
    function() {
        ...
        describe("when loaded",
            function() {
                ...
                it("calls the cards API with the project name",
                    function() {
                        var depth;
                        expect(_api.cards.GET).toHaveBeenCalledWith("yeah yeah", depth);
                    });

                describe("when loaded with a depth",
                    function() {
                        beforeEach(function() {
                            _model.load("yeah yeah", 17);
                        });

                        it("calls the cards API with the project name and the depth",
                            function() {
                                expect(_api.cards.GET).toHaveBeenCalledWith("yeah yeah", 17);
                            });
                    });

                it("gets the cards from the API",
                    function() {
                ...
                it("gets a list of features",
                    function() {
                        expect(_model.features(_storyData))
                            .toEqual([
                                _storyData[0],
                                _storyData[1],
                                _storyData[2]
                ...
                it("gets a list of stories",
                    function() {
                        expect(_model.stories(_storyData))
                            .toEqual([
                                _storyData[3],
                                _storyData[4],
                                _storyData[5]
                ...
                describe("given a card has no children",
                    function() {
                        it("gets an empty list for its children",
                            function() {
                                expect(_model.children(_model.cards()[0])).toEqual([]);
                            });
                    });

                describe("given a card has children",
                    function() {
                        it("lists it",
                            function() {
                                expect(_model.parents(_storyData))
                                    .toEqual([
                                        _storyData[2]
                                    ]);
                            });
                ...
                describe("given a card has children",
                    function() {
                        ...
                        it("gets its children sorted by priority",
                            function() {
                                expect(_children)
                                    .toEqual([
                                        _storyData[5],
                ...
                describe("given the call has not yet returned",
                    function() {
                        beforeEach(function() {
                ...
                describe("when the user changes the sort order",
                    function() {
                        beforeEach(function() {
                            $(".feature").remove();
                        ...
                        it("indexes the cards horizontally",
                            function() {
                    ...
                    function() {
                        ...
                        describe("given the API call succeeds",
                            function() {
                                ...
                                it("toasts to the users success",
                                    function() {
